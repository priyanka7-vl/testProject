...
describe('Change Password Module', () => 
{
   before('Execute Before All Tests', () => {
      browser.url('https://kalp.salesmate.io/#/app/user/security/changePassword');
      browser.pause(5000);
...
it ('C156(C)-user verify login after change password', () => {
   browser.pause(2000);
   let mail1 = $('#email')
      mail1.addValue('priyanka.vlr@rapidops.com')
      let pwd = $('#password')
      pwd.addValue('1234567')
